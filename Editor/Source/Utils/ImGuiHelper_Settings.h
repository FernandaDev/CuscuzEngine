...
namespace ImGuiHelper
{
    static void ShowTimeOverlay(bool& showing)
    {
        ...
        {
            ImGui::Text("FPS: %i", Cuscuz::Time::Get().GetFPS());
            ImGui::Text("Delta Time: %.4f seconds", static_cast<float>(Cuscuz::Time::Get().DeltaTime()));
        }
        ImGui::End();
    }
    ...
    static void ShowTimeStatsWindow(bool& showing, bool& showTimeStats)
    {
        ...
        auto vSync = Cuscuz::Engine::Get().CC_Window->GetVSync();
        ImGui::Checkbox("VSync", &vSync);
        Cuscuz::Engine::Get().CC_Window->SetVSync(vSync);
    ...
    static void ShowRendererStatsWindow(bool& showing)
    {
        ...
        const auto stats = Cuscuz::Renderer2D::GetStats();
